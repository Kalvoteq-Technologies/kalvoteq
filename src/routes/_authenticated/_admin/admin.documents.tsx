    ...
    <>
      ...
      <Section>
        <p className="flex items-center gap-1.5 text-sm text-muted-foreground">
          <Lock className="h-3.5 w-3.5" aria-hidden="true" /> Visible to admins and the owning
          engineer only.
        </p>
        ...
        {isLoading ? (
          ...
          <p className="mt-8 text-sm text-muted-foreground">
            No engineer has uploaded a document yet.
          </p>
        ) : (
              ...
              <li key={doc.id} className="flex flex-wrap items-center gap-3 p-5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 truncate text-xs text-muted-foreground">
                    ...
                    {doc.file_name} · {formatBytes(doc.size_bytes)} · uploaded{" "}
