...
const brand = { fontSize: '11px', letterSpacing: '0.16em', color: '#2563eb', fontWeight: 700, margin: '0 0 14px' }
...
const value = { fontSize: '14px', lineHeight: '22px', color: '#334155', margin: 0, whiteSpace: 'pre-wrap' as const }
